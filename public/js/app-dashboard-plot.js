	...
	angular.module('app').component('appDashboardPlot',
		{
			...
			controller: ['$scope', 'dayMeasurementRepository', 'monthDataRepository', 'inverterConfigRepository',
			function($scope, dayMeasurementRepository, monthDataRepository, inverterConfigRepository) {
